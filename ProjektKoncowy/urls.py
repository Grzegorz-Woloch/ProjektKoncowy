...
urlpatterns = [
    ...
    path('products/', views.ProduktyObecne.as_view(), name='products'),
    path('product/<int:id>/', views.ShowThisProduct.as_view(), name='ten_product'),
